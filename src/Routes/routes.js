  ...
  return (
    <Routes>
      ...
      <Route path="/" element={<Privateroute><LayoutWebsite /></Privateroute>}>
        ...
        {/* admin */}
        <Route path="/employee-manager" element={ <Privateadmin><EmployeeManager/></Privateadmin>} />
        <Route path="status" element={ <Privateadmin><Status /></Privateadmin> } />
        <Route path="review-cv" element={<Privateadmin><ReviewCV /></Privateadmin> } />
        <Route path="up-file" element={<Privateadmin><UpFile /></Privateadmin>} />
