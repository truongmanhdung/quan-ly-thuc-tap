...
const Narrows = ({isMobile}) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text, record) => (
        <Space size="middle">
          <Button type='text' style={{ color: 'blue' }} href="#" onClick={() => getDataEdit('update',record)}>
            Sửa
          </Button>
        </Space>
      ),
  ...
  return (
    <>
      <div className="status">
        ...
        <Table loading={loadings} dataSource={listNarrow} columns={columns} />
      </div>
    </>
  );
};
